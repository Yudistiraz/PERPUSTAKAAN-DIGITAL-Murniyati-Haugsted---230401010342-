...
<form method="post" action="<?= isset($buku) ? base_url('admin/buku/update/' . $buku['id']) : base_url('admin/buku/save') ?>"
      enctype="multipart/form-data" id="formBuku" class="needs-validation" novalidate>
  <?= csrf_field() ?>
  ...
  <div class="mb-3">
    ...
    <input type="file" name="gambar" id="gambar" class="form-control" <?= isset($buku) ? '' : 'required' ?> accept="image/*" onchange="previewGambar(event)">
    <div class="mt-2">
